...
| `DKQ_WAKE_BLOCK` | `1 second` | how long the doorbell's read waits before going round again, and so the longest a parked consumer waits when a wake dies with the consumer that took it |
