...
-- late, not lost, and may extend. Displacement is a fresh acquire, which overwrites the token — so a real
-- loss is a token mismatch, which this reports rather than silently renewing another holder's lock.
local held, tokens = KEYS[1], KEYS[2]
